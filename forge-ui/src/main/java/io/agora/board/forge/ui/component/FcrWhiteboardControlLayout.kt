...
import io.agora.board.forge.ui.host.ForgeBoardConverter.toWhiteboardToolType
...
class FcrWhiteboardControlLayout @JvmOverloads constructor(
    context: Context,
    ...
    private fun setupToolBoxListener() {
        ...
        binding.tabletLayout.flExitDraw.setOnClickListener {
            this@FcrWhiteboardControlLayout.visibility = GONE
        }
    }
